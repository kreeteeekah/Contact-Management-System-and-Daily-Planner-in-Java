...
import java.sql.*;
public class uanni implements ActionListener
{
 JFrame f1;
    JPanel p0,p1;
    ...
    public uanni()
    {
        ...
        l3=new JLabel("Enter Anniversary");
  ...
  public void actionPerformed(ActionEvent e)
  {
      if(e.getSource()==b1)
      {
           try
          {
              ...
              PreparedStatement stat=con.prepareStatement("update poject set canniversary=? , where username=? and cname=?");
              stat.setString(1,a1);
              stat.executeUpdate();
              q1.showMessageDialog(null,"Anniversary has been updated.","Success",1);
          }
          catch(Exception ec)
          {
      ...
      try
          {
              ...
              Class.forName("org.apache.derby.jdbc.ClientDriver");
              Connection con=DriverManager.getConnection("jdbc:derby://localhost:1527/sample","app","app");
              PreparedStatement stat=con.prepareStatement("delete from poject canniversary=? , where username=? and cname=?");
              stat.setString(1,a1);
              stat.executeUpdate();
              q1.showMessageDialog(null,"Anniversary has been deleted.","Success",1);
          }
          catch(Exception ec)
          {
              System.out.println(ec);
